    ...
    public void teleport(string locationName, Collider2D other)
    {
        switch (locationName)
        {
            case "파티룸 (입구)": GameManager.GameState = "파티룸";
                other.transform.position = new Vector3(57.5f, -1.8f, 0); ShowMapNameText(GameManager.GameState); break;
            case "파티룸 (출구)": GameManager.GameState = "복도 #F";
                other.transform.position = new Vector3(other.transform.position.x, -11.3f, 0); ShowMapNameText(GameManager.GameState); break;

            case "연회장 입구 (입구)": GameManager.GameState = "연회장 입구";
                other.transform.position = new Vector3(other.transform.position.x, 7.5f, 0f); ShowMapNameText(GameManager.GameState); break;
            ...
            case "창고 입구 (출구)": GameManager.GameState = "복도 #F";
                other.transform.position = new Vector3(other.transform.position.x, -11.6f, 0f); ShowMapNameText(GameManager.GameState); break;

            case "창고 (입구)": GameManager.GameState = "창고";
                other.transform.position = new Vector3(other.transform.position.x, 18.5f, 0f); ShowMapNameText(GameManager.GameState); break;
            case "창고 (출구)": GameManager.GameState = "창고 입구";
                other.transform.position = new Vector3(other.transform.position.x, 8.6f, 0f); ShowMapNameText(GameManager.GameState); break;
            ...
            case "RoomE Exit": GameManager.GameState = "-";
                other.transform.position = new Vector3(41.15f, -42.31f, 0f); ShowMapNameText(GameManager.GameState); break;
